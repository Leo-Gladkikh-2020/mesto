...
export const buttonCloseEdit = document.querySelector('.popup__close-edit');
export const buttonCloseAdd = document.querySelector('.popup__close-add');
export const buttonClosePlace = document.querySelector('.popup__close-place');
...
export const inputTitle = document.querySelector('.popup__input_text_title');
